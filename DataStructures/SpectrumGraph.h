...
public:
	...
	std::vector<std::vector<Peak>> spectralPeaks;
	std::vector<std::map<std::pair<int, int>, std::string>> spectralEdges;
	...
	std::map<std::pair<int, int>, std::string> computeSpectralEdges(std::vector<std::vector<Peak>>, int);
	...
	std::vector<std::map<std::pair<int, int>, std::string> > spectralPrefixSuffixConnectors;
	std::map<std::pair<int, int>, std::string> computePrefixSuffixConnectors(std::vector<Peak>, std::map<std::pair<int, int>, std::string>, float, int);
